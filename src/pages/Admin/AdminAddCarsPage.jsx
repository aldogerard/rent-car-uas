...
import { addProduct, getDataCarsById, updateProduct } from "../../utils/api.js";
import { useEffect } from "react";

const AdminAddCarsPage = () => {
  const { id } = useParams();
  ...
  return (
    <SideBarAdmin>
      <div className="w-full py-2 mb-10 border-b border-black/70">
        <h1 className="text-xl md:text-4xl font-medium">Add Cars</h1>
      </div>
...
export default AdminAddCarsPage;
