      ...
      <main className="pt-[50px] md:pt-[150px] lg:pt-[130px] -z-50">
        <section className="h-[80vh] w-full bg-[url(images/hero.jpg)] bg-center bg-cover">
          <div className="w-full h-full bg-black/50">
            <div className="container px-4 md:px-0 flex flex-col justify-center h-full text-white gap-6">
              ...
              <Link to="/cars">
                <div className="bg-primary w-36 py-2 text-center text-black rounded-md">
                  Reserve Now
                </div>
              </Link>
            </div>
        ...
        <section className="container py-8 w-full flex flex-wrap-reverse items-center px-4 md:px-0">
          <div className="w-full lg:w-1/2">
            <h3 className="text-xl lg:text-2xl text-primary font-semibold">
              About Us
            </h3>
            <h1 className="text-2xl lg:text-3xl font-bold">
              Welcome to Rent Car Service
            </h1>
            <p className="text-gray-500 font-light text-sm mt-2">
              We aim to offer car rental services of the highest quality, with
              flexible duration options, to ensure that our users feel
              completely comfortable throughout their car rental experience.
            </p>
          ...
          <div className="w-full lg:w-1/2">
            <img
              ...
              alt=""
              className="w-2/3 lg:w-4/5 mx-auto"
            />
          </div>
        </section>
        <section className="container mx-auto w-full flex flex-wrap justify-center items-center bg-red-00 py-8 px-4 md:px-0">
          ...
          <Link
            to={`/cars`}
            className="bg-primary mb-2 flex justify-center items-center gap-2 w-40 py-2 text-center text-black rounded-md transition-all duration-150 focus:bg-amber-500"
            type="submit"
          >
            View More...
          </Link>
